...
- [x] Create Products page with sections:
  - Featured Pieces
...
- [x] All pages restructured per spec
- [x] All images removed (text-only)
- [x] All duplicate products removed
- [x] All forms working with validation
- [x] All navigation updated and tested
- [x] NDIS content integrated properly
- [x] SEO basics implemented
- [x] Footer added to all pages
- [x] Build successful (no errors)
- [x] All pages tested (desktop & mobile)
